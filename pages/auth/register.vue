<template>
  <Container class="px-4 flex items-center justify-center gap-x-10 lg:px-8">
    <div
    ...
    <Wrapper class="space-y-6 sm:w-3/4 lg:w-1/2 shrink-0 lg:px-16">
      ...
      <div class="space-y-4">
        <form action="" class="space-y-4">
          <InputCustom label="Username" id="username" type="text" placeholder="jhon doe" v-model="payload.password"
