        ...
        <form @submit.prevent="handleSubmit" class="flex flex-col gap-y-4" v-else>
            ...
            <div class="space-y-4 lg:w-1/2 relative">
                <label for="image"
                    ...
                    <input type="file" id="image" @change="handleImage" class="hidden" accept="image/png,image/jpeg"
                        ref="fileInput">
                </label>
                <Transition name="fade">
                    <div class="w-full h-48 absolute top-0 rounded-md overflow-hidden bg-white box-border p-2"
                        v-if="viewImage">
